...
# python sellar_glb.py <pieza.glb> <nota>
...
ruta.write_bytes(struct.pack('<III', magic, version, 12 + len(cuerpo)) + cuerpo)
print(f'sellado {ruta.name}: {len(datos)} -> {12 + len(cuerpo)} bytes')
